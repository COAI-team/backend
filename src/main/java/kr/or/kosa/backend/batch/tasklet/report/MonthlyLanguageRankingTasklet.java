...
@Component
public class MonthlyLanguageRankingTasklet implements Tasklet {
    private final AdminStatisticsBatchMapper adminStatisticsBatchMapper;

    public MonthlyLanguageRankingTasklet(AdminStatisticsBatchMapper adminStatisticsBatchMapper) {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        adminStatisticsBatchMapper.deleteLanguageRankingMonthly(year, month);
        adminStatisticsBatchMapper.insertMonthlyLanguageRanking(year, month);
