...
@Component
@Slf4j
public class MonthlyAlgoSolveRankingTasklet implements Tasklet {
    private final AdminStatisticsBatchMapper adminStatisticsBatchMapper;

    public MonthlyAlgoSolveRankingTasklet(AdminStatisticsBatchMapper adminStatisticsBatchMapper) {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        adminStatisticsBatchMapper.deleteAlgoSolveRankingMonthly(year, month);
        adminStatisticsBatchMapper.insertMonthlyAlgoSolveRanking(year, month);
