...
-- MONITORING_SESSIONS은 UUID(VARCHAR) Primary Key 사용으로 AUTO_INCREMENT 불필요
...
SELECT
    ...
    COUNT(CASE WHEN s.SOLVE_MODE = 'FOCUS' THEN 1 END) AS focus_mode_count,
    COUNT(CASE WHEN s.SOLVE_MODE = 'BASIC' THEN 1 END) AS basic_mode_count,
